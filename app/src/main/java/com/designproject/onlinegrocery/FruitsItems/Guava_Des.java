...
public class Guava_Des extends AppCompatActivity {

    TextView quantityNumber, GuavaName, GuavaPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GuavaName = findViewById(R.id.ItemGuava);
        GuavaPrice = findViewById(R.id.GuavaPrice);

        GuavaName.setText("Guava");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Guava_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Guava_Price);
                GuavaPrice.setText(setnewPrice);
            }
        });
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Guava_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Guava_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Guava_Des.this, Fruits.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Guava_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
    ...
    private boolean saveCart() {
        String name = GuavaName.getText().toString();
        String price = GuavaPrice.getText().toString();
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            GuavaName.setText(nameofItem);
            GuavaPrice.setText(priceofItem);
