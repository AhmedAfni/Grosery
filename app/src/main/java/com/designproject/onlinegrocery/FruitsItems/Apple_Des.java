...
public class Apple_Des extends AppCompatActivity {

    TextView quantityNumber, AppleName, ApplePrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppleName = findViewById(R.id.ItemApple);
        ApplePrice = findViewById(R.id.ApplePrice);

        AppleName.setText("Apple");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Apple_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Apple_Price);
                ApplePrice.setText(setnewPrice);
            }
        });
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Apple_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Apple_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Apple_Des.this, Fruits.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Apple_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
    ...
    private boolean saveCart() {
        String name = AppleName.getText().toString();
        String price = ApplePrice.getText().toString();
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            AppleName.setText(nameofItem);
            ApplePrice.setText(priceofItem);
