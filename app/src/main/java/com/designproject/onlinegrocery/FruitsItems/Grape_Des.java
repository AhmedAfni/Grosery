...
public class Grape_Des extends AppCompatActivity {

    TextView quantityNumber, GrapeName, GrapePrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GrapeName = findViewById(R.id.ItemGrape);
        GrapePrice = findViewById(R.id.GrapePrice);

        GrapeName.setText("Grapes");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Grape_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Grape_Price);
                GrapePrice.setText(setnewPrice);
            }
        });
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Grape_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Grape_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Grape_Des.this, Fruits.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Grape_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
    ...
    private boolean saveCart() {
        String name = GrapeName.getText().toString();
        String price = GrapePrice.getText().toString();
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            GrapeName.setText(nameofItem);
            GrapePrice.setText(priceofItem);
