package com.designproject.onlinegrocery.SeaFoodItems;
...
public class Clams_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clams);
        ...
        itemName = findViewById(R.id.ItemClams);
        itemPrice = findViewById(R.id.ClamsPrice);

        itemName.setText("Clams");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Clams_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Clams_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Clams_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Clams_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Clams_Des.this, SeaFood.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Clams_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
