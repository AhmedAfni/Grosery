...
public class CatFish_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName = findViewById(R.id.ItemCatFish);
        itemPrice = findViewById(R.id.CatFishPrice);

        itemName.setText("Cat Fish");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Cat_Fish_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Cat_Fish_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(CatFish_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Cat_Fish_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CatFish_Des.this, SeaFood.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CatFish_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
