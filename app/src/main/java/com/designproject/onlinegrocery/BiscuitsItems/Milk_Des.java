...
public class Milk_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName = findViewById(R.id.ItemMilkBic);
        itemPrice = findViewById(R.id.MilkPrice);

        itemName.setText("Milk Biscuits");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Milk_Biscuits_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Milk_Biscuits_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Milk_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Milk_Biscuits_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Milk_Des.this, Biscuits.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Milk_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
