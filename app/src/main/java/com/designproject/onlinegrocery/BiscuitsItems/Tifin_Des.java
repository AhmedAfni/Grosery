...
public class Tifin_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tifin);
        ...
        itemName = findViewById(R.id.ItemTifin);
        itemPrice = findViewById(R.id.TifinPrice);

        itemName.setText("Tifin Onion");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Tifin_Onion_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Tifin_Onion_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Tifin_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Tifin_Onion_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Tifin_Des.this, Biscuits.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tifin_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
