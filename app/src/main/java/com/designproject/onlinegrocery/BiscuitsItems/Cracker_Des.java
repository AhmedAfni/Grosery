package com.designproject.onlinegrocery.BiscuitsItems;
...
public class Cracker_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cracker);
        ...
        itemName = findViewById(R.id.ItemCracker);
        itemPrice = findViewById(R.id.CrackerPrice);

        itemName.setText("Cream Cracker");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Cream_Cracker_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Cream_Cracker_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Cracker_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Cream_Cracker_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Cracker_Des.this, Biscuits.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cracker_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
