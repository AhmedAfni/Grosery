...
public class Breadbun_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breadbun);
        ...
        itemName = findViewById(R.id.ItemBreadBun);
        itemPrice = findViewById(R.id.BreadBunPrice);

        itemName.setText("Bread Bun");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Bread_Bun_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Bread_Bun_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(Breadbun_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Bread_Bun_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Breadbun_Des.this, Bakery.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Breadbun_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
