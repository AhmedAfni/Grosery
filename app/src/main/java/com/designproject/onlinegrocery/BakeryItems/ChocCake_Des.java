...
public class ChocCake_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choc_cake);
        ...
        itemName = findViewById(R.id.ItemChocCake);
        itemPrice = findViewById(R.id.ChoclateCakePrice);

        itemName.setText("Choclate Cake");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Choclate_Cake_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Choclate_Cake_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(ChocCake_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Choclate_Cake_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ChocCake_Des.this, Bakery.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChocCake_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
