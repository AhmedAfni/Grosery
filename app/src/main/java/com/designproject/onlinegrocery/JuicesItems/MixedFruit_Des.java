...
public class MixedFruit_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mixed_fruit);
        ...
        itemName = findViewById(R.id.ItemMixed);
        itemPrice = findViewById(R.id.MixedFruitPrice);

        itemName.setText("Mixed Fruit");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Mixed_Fruit_price = basePrice * quantity;
                String setnewPrice = String.valueOf(Mixed_Fruit_price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(MixedFruit_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Mixed_Fruit_price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MixedFruit_Des.this, Juices.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MixedFruit_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
