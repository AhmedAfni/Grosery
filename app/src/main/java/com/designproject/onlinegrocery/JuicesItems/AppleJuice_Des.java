...
public class AppleJuice_Des extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apple_juice);
        ...
        itemName = findViewById(R.id.ItemAppleJuice);
        itemPrice = findViewById(R.id.AppleJuicePrice);

        itemName.setText("My Juice Apple");
        ...
        buttonPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                quantity++;
                displayQuantity();
                int Apple_Juice_Price = basePrice * quantity;
                String setnewPrice = String.valueOf(Apple_Juice_Price);
        ...
        buttonMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (quantity == 0) {
                    Toast.makeText(AppleJuice_Des.this, "Can't decrease quantity < 0", Toast.LENGTH_SHORT).show();
                }else {
                    quantity--;
                    displayQuantity();
                    int Apple_Juice_Price = basePrice * quantity;
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AppleJuice_Des.this, Juices.class);
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AppleJuice_Des.this, My_Cart.class);
                startActivity(intent);
                saveCart();
            }
        });
